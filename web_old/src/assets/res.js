...
/***/ function(module, exports, __webpack_require__) {
	...
	var res = {};
	var res_init = function(root, init) {
    var q = init('Authorization', '/api');
    
    var r = root.user = {};
        r.get = q('/user', 'get');
        r.get_me = q('/user/me', 'get');
        r.post_forgot = q('/user/forgot', 'post');
        r.post_login = q('/user/login', 'post');
        r.post_reset = q('/user/reset', 'post');
        r.post_signup = q('/user/signup', 'post');
        r.post_sync_repo = q('/user/sync_repo', 'post');
        r.post_verify = q('/user/verify', 'post');
        r.put = q('/user', 'put');
        r.put_security = q('/user/security', 'put');
        
    var r = root.comment = {};
        r.get = q('/comment', 'get');
        r.post = q('/comment', 'post');
        
    var r = root.info = {};
        r.get = q('/info', 'get');
        r.get_400 = q('/info/400', 'get');
        r.get_403 = q('/info/403', 'get');
        r.get_404 = q('/info/404', 'get');
        r.get_500 = q('/info/500', 'get');
        
    var r = root.article = {};
        r.get = q('/article', 'get');
        r.get_list = q('/article/list', 'get');
        r.post = q('/article', 'post');
        
    var r = root.permission = {};
        r.delete = q('/permission', 'delete');
        r.get = q('/permission', 'get');
        r.get_permit = q('/permission/permit', 'get');
        r.post = q('/permission', 'post');
        
    var r = root.captcha = {};
        r.get = q('/captcha', 'get');
        r.get_check = q('/captcha/check', 'get');
