...
(function(res) {
    ...
    ress.article={};
        ...
        ress.article.get=function(data,fn,progress){
        ...
        ress.article.get_list=function(data,fn,progress){
            header={accept:"application/json,application/xhtml+xml,application/xml;q=0.9,image/webp,*/*;q=0.8"};
